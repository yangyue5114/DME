...
def predict(input_image, prompt, fitting_degree, ddim_steps, scale, seed,
    ...
    # 调整图像大小，640/512
    if task!='image-outpainting' and (size1>2000 or size2>2000):
        if size1 < size2:
...
parser.add_argument('--task', type=str, default='text-guided', required=True, help="['text-guided', 'object-removal', 'shape-guided', 'image-outpainting']")
...
parser.add_argument('--main_mme_tasks_dir', type=str, default='/mnt/petrelfs/yangyue/dynamic_eval/evaluation/generate_mask/ten_masks/MM_bench/add', required=True)
parser.add_argument('--result_save_dir', type=str, default='/mnt/petrelfs/yangyue/dynamic_eval/evaluation/inpainting/PowerPaint/add_task_results/MM_bench', required=True)
args = parser.parse_args()


# main_mme_tasks_dir = '/mnt/petrelfs/yangyue/dynamic_eval/evaluation/generate_mask/ten_masks/MM_bench/add'
# result_save_dir = '/mnt/petrelfs/yangyue/dynamic_eval/evaluation/inpainting/PowerPaint/add_task_results/MM_bench'
main_mme_tasks_dir = args.main_mme_tasks_dir
    ...
    if filename!= 'e':
        ...
        for parameter_json_files_path in parameter_json_files_paths:
            ...
            for img_mask_data in img_mask_datas:
                ...
                img_result_save_path_name = os.path.join(per_img_result_dir,text_guided_prompt.replace(" ", "_"))
